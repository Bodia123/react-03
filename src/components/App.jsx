  ...
  fetchGalleryItems = (nextQuery, nextPage) => {
    ...
    postApiService.fetchPost().then(data => {
      ...
      if (!data.totalHits) {
        ...
        return toast.warn(
          'Зображень по даному запиту не знайдено! Спробуйте ще раз.'
        );
      }
      ...
      if (nextPage === 1) {
        toast.success(`Чудово! Знайдено ${postApiService.hits} зображень.`);
      }
  ...
  render() {
    ...
    return (
      <AppContent>
        ...
        {error && <Title>Введіть, будь ласка, слово</Title>}
